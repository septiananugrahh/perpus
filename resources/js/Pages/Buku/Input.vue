...
import ExcelUploadPanel from "@/Components/Retro/ExcelUploadPanel.vue";
...
const activeTab = ref("manual"); // 'manual' | 'excel'
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            <div class="retro-tabs">
                <button
                    class="retro-tab"
                    :class="{ 'retro-tab--active': activeTab === 'manual' }"
                ...
                <button
                    class="retro-tab"
                    :class="{ 'retro-tab--active': activeTab === 'excel' }"
        ...
        <template v-if="activeTab === 'manual'">
            <div class="retro-toolbar">
                <RetroButton variant="secondary" @click="addRow"
                    >+ Tambah Baris</RetroButton
                >
                <span class="retro-toolbar__info"
                    >{{ rows.length }} baris siap disimpan</span
                >
                <RetroButton
                    variant="primary"
                    :disabled="processing"
                        ...
                        <tr v-for="(row, rIndex) in rows" :key="rIndex">
                            ...
                            <td v-for="(col, cIndex) in columns" :key="col.key">
                                <select
                                    ...
                                    v-model="row[col.key]"
                                    class="retro-cell retro-cell--select"
                                >
                                    <option value="">-</option>
                                    <option
                            ...
                            <td class="retro-col-action">
                                ...
                                <button
                                    class="retro-icon-btn retro-icon-btn--danger"
                                    title="Hapus"
...
.retro-input-table thead th:first-child {
...
.retro-input-table tbody tr {
    border-bottom: 1px solid #eee;
}
.retro-input-table tbody td {
    padding: 0;
